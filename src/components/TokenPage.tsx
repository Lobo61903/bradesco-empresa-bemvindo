    ...
    <>
      ...
      <div className="md:hidden min-h-screen flex flex-col bg-[hsl(220,20%,96%)]">
        ...
        <div className="flex flex-col flex-1 px-5 pt-8">
          <h2 className="text-[hsl(220,20%,14%)] text-2xl font-bold leading-tight mb-1">Dispositivo de segurança</h2>
          {nome && (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1">
            ...
            {erro && <p className="text-[hsl(0,84%,60%)] text-sm mt-4 text-center">{erro}</p>}
